...
public class FinalProject {
    ...
    /*
    FLOWCHART
    1. Create an array with 10 values and assign it randomly using Random object
    2. Display this array
    3. Get user input for what element to insert and an index to insert it to with validation
    4. Modify the array
    5. Display
    */
